...
/*Data source
*-----------
*The Nigeria General Household Survey (GHS) was collected by the Nigeria National Bureau of Statistics (NBS) 
...
*"Raw DTA files" folder within the "Nigeria GHSP - LSMS-ISA Wave 3 (2015-16)" folder.  
*The do.file constructs common and intermediate variables, saving dta files when appropriate 
*in the "\Nigeria GHSP - LSMS-ISA Wave 3 (2015-16)\Merged Data" folder or "\Nigeria GHSP - LSMS-ISA Wave 3 (2015-16)\Collapse Data" folder.
...
*Those summary statistics are created in the excel file "NG_W3_plot_table1.rtf", which is saved in the "\Nigeria GHSP - LSMS-ISA Wave 3 (2015-16)\Final files" folder.
