clear
set more off
global input "//evansfiles/Files/Project/EPAR/Ethiopia LSMS-ISA/Analysis/357 Land Tenure Analysis/Wave 2/Raw Data"
global merge "//evansfiles/Files/Project/EPAR/Ethiopia LSMS-ISA/Analysis/357 Land Tenure Analysis/Wave 2/Merged Data"
global collapse "//evansfiles/Files/Project/EPAR/Ethiopia LSMS-ISA/Analysis/357 Land Tenure Analysis/Wave 2/Collapse Data" 
...
save "$merge\ETH_W2_aggregate.dta", replace 
...
export excel household_id2 parcel_id region plot_cert hoh_fem hoh_age hoh_literate ///
plot_area plot_area_owned plot_area_notowned  ///
plot_own_gender fem_plot_owned fem_only_plot_own male_only_plot_own mixed_gen_plot_own plot_right_sell ///
dailycons poverty125 poverty2 wave using "\\evansfiles\files\Project\EPAR\Working Files\357 - Land Reform Review\Tableau\Excel\ETH_W2_Plot.xls", sheetmodify firstrow(varlabel)

keep household_id2 parcel_id region plot_cert hoh_fem hoh_age hoh_literate ///
plot_area plot_area_owned plot_area_notowned  ///
plot_own_gender fem_plot_owned fem_only_plot_own male_only_plot_own mixed_gen_plot_own plot_right_sell ///
...
save "$merge/ETH_W2_tableau.dta", replace 
...
collapse (sum) `sum_vars', by (household_id2) 
...
save "$merge/ETH_w2_Plot_HH_sum_collapse.dta", replace
...
save "$collapse/ETH_w2_comm_land_data.dta", replace
