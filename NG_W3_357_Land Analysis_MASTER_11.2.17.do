...
global input "\\evansfiles\files\Project\EPAR\Nigeria LSMS-ISA\Analysis\357 Land Tenure Indicators\2015-2016\Data"
global merge "\\evansfiles\files\Project\EPAR\Nigeria LSMS-ISA\Analysis\357 Land Tenure Indicators\2015-2016\Merged Data"
global collapse "\\evansfiles\files\Project\EPAR\Nigeria LSMS-ISA\Analysis\357 Land Tenure Indicators\2015-2016\Collapse Data"
...
dailycons poverty125 poverty2 wave using "\\evansfiles\files\Project\EPAR\Working Files\357 - Land Reform Review\Tableau\Excel\NG_W3_Plot.xls", sheetmodify firstrow(varlabel)

label define state 1 "ABIA" 2 "ADAMAWA" 3 "AKWA IBOM" 4 "ANAMBRA" 5 "BAUCHI" 6 "BAYELSA" 7 "BENUE" 8 "BORNO" 9 "CROSS RIVER" 10 "DELTA" 11 "EBONYI" 12 "EDO" 13 "EKITI" 14 "ENUGU" 15 "GOMBE" 16 "IMO" 17 "17. JIGAWA" 18 "KADUNA" 19 "KANO" 20 "KATSINA" 21 "KEBBI" 22 "KOGI" 23 "23. KWARA" 24 "LAGOS" 25 "NASARAWA" 26 "NIGER" 27 "OGUN" 28 "ONDO" 29 "OSUN" 30 "OYO" 31 "PLATEAU" 32 "RIVERS" 33 "SOKOTO" 34 "TARABA" 35 "YOBE" 36 "ZAMFARA" 37 "FCT ABUJA", replace
...
save "$merge\NG_W3_tableau.dta", replace 
