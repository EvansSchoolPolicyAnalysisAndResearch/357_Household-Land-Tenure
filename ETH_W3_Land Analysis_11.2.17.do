clear
set more off 
global input "//evansfiles/Files/Project/EPAR/Ethiopia LSMS-ISA/Analysis/357 Land Tenure Analysis/Wave 3/Raw Data"
global merge "//evansfiles/Files/Project/EPAR/Ethiopia LSMS-ISA/Analysis/357 Land Tenure Analysis/Wave 3/Merged Data"
global collapse "//evansfiles/Files/Project/EPAR/Ethiopia LSMS-ISA/Analysis/357 Land Tenure Analysis/Wave 3/Collapse Data" 
...
save "$merge\ETH_W3_aggregate.dta", replace 
...
dailycons poverty125 poverty2 wave using "\\evansfiles\files\Project\EPAR\Working Files\357 - Land Reform Review\Tableau\Excel\ETH_W3_Plot.xls", sheetmodify firstrow(varlabel)
...
save "$merge/ETH_W3_tableau.dta", replace 
...
save "$merge/ETH_w3_Plot_HH_sum_collapse.dta", replace
...
save "$collapse/ETH_w3_comm_land_data.dta", replace
