...
*"Raw DTA files" folder within the "Tanzania TNPS - LSMS-ISA - Wave 3 (2012-13)" folder.
*The do.file constructs common and intermediate variables, saving dta files when appropriate 
*in the "\Tanzania TNPS - LSMS-ISA - Wave 3 (2012-13)\Merged Data" folder or "\Tanzania TNPS - LSMS-ISA - Wave 3 (2012-13)\Collapse Data" folder.
...
*Those summary statistics are created in the excel file "TZ_W3_plot_table1.rtf", which is saved in the "\Tanzania TNPS - LSMS-ISA - Wave 3 (2012-13)\Final files" folder.
